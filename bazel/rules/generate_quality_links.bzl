...
def _generate_quality_links_impl(ctx):
    ...
    if docs_version == "latest":
        ...
        codeql_integrity_ref = (
            "`Database integrity "
            "<quality/codeql/database_integrity_report.md>`__"
        )
        codeql_deviations_ref = (
            "`Deviations <quality/codeql/deviations_report.md>`__"
        )
        codeql_compliance_ref = (
            "`Compliance summary "
        ...
        codeql_recat_ref = codeql_report_hint    content = (
